...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2017 at 01:26 AM
...
--
-- Constraints for table `katsu_answers_table`
--
ALTER TABLE `katsu_answers_table`
  ADD CONSTRAINT `katsu_answers_table_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `katsu_users_table` (`user_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `katsu_answers_table_ibfk_2` FOREIGN KEY (`question_id`) REFERENCES `katsu_questions_table` (`question_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `katsu_answers_table_ibfk_3` FOREIGN KEY (`victim_id`) REFERENCES `katsu_childs_table` (`child_id`) ON UPDATE CASCADE;

--
-- Constraints for table `katsu_childs_table`
--
ALTER TABLE `katsu_childs_table`
  ADD CONSTRAINT `katsu_childs_table_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `katsu_users_table` (`user_id`) ON UPDATE CASCADE;

--
-- Constraints for table `katsu_login_logs_table`
--
ALTER TABLE `katsu_login_logs_table`
  ADD CONSTRAINT `katsu_login_logs_table_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `katsu_users_table` (`user_id`) ON UPDATE CASCADE;
